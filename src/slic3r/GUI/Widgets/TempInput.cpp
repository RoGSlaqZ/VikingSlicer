    ...
    , text_color(std::make_pair(wxColour(0xAC,0xAC,0xAC), (int) StateColor::Disabled), std::make_pair(0x6B6B6B, (int) StateColor::Normal))
{
    hover  = false;
    radius = 0;
    border_color = StateColor(std::make_pair(*wxWHITE, (int) StateColor::Disabled), std::make_pair(0x5E81AC, (int) StateColor::Focused), std::make_pair(0x5E81AC, (int) StateColor::Hovered),
...
void TempInput::render(wxDC &dc)
{
    ...
    if (warning_mode) {
        ...
        border_color = StateColor(std::make_pair(*wxWHITE, (int) StateColor::Disabled), std::make_pair(0x5E81AC, (int) StateColor::Focused),
                                  std::make_pair(0x5E81AC, (int) StateColor::Hovered), std::make_pair(*wxWHITE, (int) StateColor::Normal));
    }
